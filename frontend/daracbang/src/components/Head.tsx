        ...
        <Header style={{ backgroundColor: "#F2EBEB" }}>
            ...
            <BtnGroup >
                ...
                <Button onClick={muteClickHandler}>
                    {mPic === "Music" ? <img src={Music} alt="music" style={{ height: "60px", width: "70px" }} /> :
                ...
                <Badge
                    ...
                    badgeContent={
                        <SmallAvatar alt="Remy Sharp" src={CheckAlert} />
                    }
                >
                    <Button onClick={handleClick}><img src={Bell} alt="bell" /></Button>
                    <Popover
                        open={open}
                        onClick={handleClose}
