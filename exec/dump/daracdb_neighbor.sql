...
CREATE TABLE `neighbor` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKqqhmdornw0jb6862llhe1t23c` (`accepter_id`),
  KEY `FK9nb4jhb7kbuxfjs4mccohkw3o` (`requester_id`),
  CONSTRAINT `FK9nb4jhb7kbuxfjs4mccohkw3o` FOREIGN KEY (`requester_id`) REFERENCES `member` (`id`),
  CONSTRAINT `FKqqhmdornw0jb6862llhe1t23c` FOREIGN KEY (`accepter_id`) REFERENCES `member` (`id`)
