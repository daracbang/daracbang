...
CREATE TABLE `bgm` (
  ...
  `bgm_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `video_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK3q9b1mvwavxpxyife0t5w8ejd` (`member_id`),
  CONSTRAINT `FK3q9b1mvwavxpxyife0t5w8ejd` FOREIGN KEY (`member_id`) REFERENCES `member` (`id`)
...
-- Dump completed on 2023-11-17 10:02:33
